...
export const SliderCard = props => {
  ...
  return (
    <>
      <Row>
        <Col span={6}>
          <Title level={2} className="filterTitle">
            Launchpad Drops
          </Title>
        </Col>
        <Col span={8}>
          <Row className="sliderFilter-wrap">
            <Col
              id="1"
              className={
                active !== 1 ? 'itemFilter ' : 'itemFilter activeFilter'
              }
            ...
            <Col
              id="2"
              className={
                active !== 2 ? 'itemFilter ' : 'itemFilter activeFilter'
              }
              onClick={changeFilter}
              span={8}
            >
            ...
            <Col
              id="3"
              className={
                active !== 3 ? 'itemFilter ' : 'itemFilter activeFilter'
              }
              onClick={changeFilter}
              span={8}
            >
      ...
      <div className="slider-wrap" ref={sliderCard}>
        {loading &&
          [...Array(5)].map((_, idx) => (
            <Col span={5}>
              <CardLoader key={idx} width={200} height={370} />
            </Col>
          ))}
        {!loading &&
          cardDat.map((c: Card, idx) => (
            <Col span={5}>
              <CardComponent
                key={idx}
