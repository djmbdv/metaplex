  ...
  return (
    <Layout style={{ margin: 0, marginTop: 30 }}>
      <MetaplexOverlay visible={showCongrats}>
        ...
        <Button className="overlay-btn" onClick={() => setShowCongrats(false)}>
          OK
        </Button>
      </MetaplexOverlay>
      <Row
        className="details-launchpad"
        gutter={{ xs: 24, sm: 16, md: 24, lg: 32 }}
      >
        <Col
          md={{ span: 12, order: 1 }}
          xs={{ span: 24, order: 2 }}
          className="gutter-row datos-launchpad"
        >
          <Row>
            <Col>
              <Button className="btn-outline-launchpad" size="small">
                FEATURED LAUNCH
              </Button>
            </Col>
          </Row>
          ...
          <Row className="wrap-total-social">
            <Col>
              <Button className="btn-outline-launchpad">VERIFIED</Button>
            </Col>
            <Col>
              <Button className="btn-outline-launchpad">ESCROW 15D</Button>
            </Col>
            <Col>
              <Row className="wrap-total-social">
                <Col>
                  <p id="total-items-launchpad">TOTAL ITEMS 1000 </p>
                </Col>
                <Col>
                  <SocialNetworking
                    className="redSocial"
          ...
          <Row>
            <Col span={20}>
              <Paragraph className="details-paragraph">
                Louis XV 1996 received a Gold medal at The World’s Finest Glass
                of Bubbly awards in 2017. Subtle and voluptuous, revealing a
                paradox of flavors, fine but intense, underlined by an
                incandescent yellow gold color. This Champagne's exceptional
                elegance will seduce connoisseurs of great champagnes. 75 cl
              </Paragraph>
        ...
        >
          <Row>
            <Col span={24} className="wrap-btnCandy">
              <CachedImageContent
          ...
          <Row className="wrap-btnCandy-p">
            {' '}
            <Col span={12}>
              {!wallet.connected ? (
                <ConnectButton className=" btn-mint">
                  Connect Wallet
                </ConnectButton>
            ...
            <Col span={12}>
                  ...
                  <Progress
                    ...
                    percent={Math.floor(
                      (candyMachine.state.itemsRedeemed /
                        (candyMachine?.state.endSettings?.number
                          ? Math.min(
              ...
              <Row>TOTAL MINTED {candyMachine?.state?.itemsRedeemed}</Row>
            </Col>
          </Row>
        </Col>
      </Row>
