      ...
      <Row className="launchpad-card">
        <Col xs={{ offset: 2 }}>
          ...
          <Col span={6}>
            <CardComponent
              key={'1'}
              description={'Louis  XV deVenoge Collection'}
              posterUri={
                'https://wincbphavq4xu2b5ug5zdyui4glhbeeoeygnur4uynygfpou.arweave.net/sho_gvOCsOXp-oPaG7keKI4ZZwkI4mDNp_HlMNwYr3U?ext=gif'
              }
              items={'1000'}
              price={'0.001'}
              name={'Louis XV'}
              link={'/launchpad/6CDkZfay8Q4S82e3bo2tYPBXGC5mLkHewuMYcedmCeWU'}
              pubkey={'1'}
            />
          </Col>
